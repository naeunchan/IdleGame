...
export const milestoneDefinitions: MilestoneDefinition[] = [
  ...
  },
  {
    ...
    name: '첫 팀 미팅',
    summary: '창업견 혼자 일하던 작업실에 첫 팀원을 들여 협업을 시작합니다.',
    requirementType: 'team',
    targetValue: 2,
    rewardLabel: '간식 수레 정비 해금',
    unlocks: ['간식 수레 업그레이드'],
  },
  {
    id: 'local-buzz',
    name: '동네 입소문',
    summary: '평판을 쌓아 더 좋은 의뢰와 장식 보상을 받을 준비를 합니다.',
    requirementType: 'reputation',
    targetValue: 8,
    rewardLabel: '성과 진열장 정비 해금',
    unlocks: ['성과 진열장 업그레이드'],
  },
  {
    id: 'toolchain-stack',
    name: '작업 도구 정착',
    summary: '작업실 정비를 세 단계 이상 진행해 장기 운영 기반을 만듭니다.',
    requirementType: 'upgrade-levels',
    targetValue: 3,
    rewardLabel: '정비 루프 완성',
    unlocks: ['업그레이드 운영 루프 고착'],
  },
  {
    id: 'neighborhood-studio',
    name: '동네 개발사 도약',
    summary: '다섯 번째 납품까지 달성해 더 큰 작업실로 도약할 준비를 마칩니다.',
    requirementType: 'projects',
    targetValue: 5,
    rewardLabel: '중기 성장권 진입',
    unlocks: ['골목 스튜디오 운영 안정화'],
  },
];
